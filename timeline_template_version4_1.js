AJS.$(document).ready(function () {
    ...
    function redraw(c,ctx) {
        ...
        if(array_milestone_case[0].length>4){
            ...
            array_milestone_case_extend_0.push(array_milestone_case_extend[0][array_milestone_case_extend[0].length-3]);
            array_milestone_case_extend_0.push(array_milestone_case_extend[0][array_milestone_case_extend[0].length-2]);
            array_milestone_case_extend_0.push(array_milestone_case_extend[0][array_milestone_case_extend[0].length-1]);
