            ...
            for (var j = 0; j<array_milestone_case[i].length; j++){
                switch(i){
                    case 0:
                        ...
                        addMileStone(array_milestone_case_extend[i][j],array_milestone_case[i][j],past_d,future_d,current_d_line_position,range_d_ok_line_position,node_space_sum,initial_point,context);
                        break;
                    case 1:
                        node_space_sum += node_space;
                        addMileStone(array_milestone_case_extend[i][j],array_milestone_case[i][j],past_d,future_d,current_d_line_position,range_d_ok_line_position,node_space_sum,initial_point,context);
